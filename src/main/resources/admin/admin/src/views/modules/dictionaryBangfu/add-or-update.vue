<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="帮扶产品编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="帮扶产品编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="帮扶产品编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="帮扶产品编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="帮扶产品" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="帮扶产品" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="帮扶产品" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('帮扶产品不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="bangfu_types";
                        ruleForm["dicName"]="帮扶产品";
                        this.$http({
