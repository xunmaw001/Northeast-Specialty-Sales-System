<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='nonghu'"  label='农户编号' prop="nonghuUuidNumber">
               <el-input v-model="ruleForm.nonghuUuidNumber"disabled="true"   placeholder='农户编号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='nonghu'"  label='农户姓名' prop="nonghuName">
               <el-input v-model="ruleForm.nonghuName"  placeholder='农户姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='nonghu'"  label='农户手机号' prop="nonghuPhone">
               <el-input v-model="ruleForm.nonghuPhone"  placeholder='农户手机号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='nonghu'"  label='农户身份证号' prop="nonghuIdNumber">
               <el-input v-model="ruleForm.nonghuIdNumber"  placeholder='农户身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='nonghu'" label='农户照片' prop="nonghuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='nonghu'"  label='农户邮箱' prop="nonghuEmail">
               <el-input v-model="ruleForm.nonghuEmail"  placeholder='农户邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='nonghu'"  label='余额' prop="newMoney">
...
|| flag=='nonghu')"  label="性别" prop="sexTypes">
...
// 注册表 农户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.nonghuUuidNumber)&& 'nonghu'==this.flag){
                             this.$message.error('农户编号不能为空');
                             return
                         }

                         if((!this.ruleForm.nonghuName)&& 'nonghu'==this.flag){
                             this.$message.error('农户姓名不能为空');
                             return
                         }

                             if( 'nonghu' ==this.flag && this.ruleForm.nonghuPhone&&(!isMobile(this.ruleForm.nonghuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.nonghuIdNumber)&& 'nonghu'==this.flag){
                             this.$message.error('农户身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.nonghuPhoto)&& 'nonghu'==this.flag){
                             this.$message.error('农户照片不能为空');
                             return
                         }

                             if( 'nonghu' ==this.flag && this.ruleForm.nonghuEmail&&(!isEmail(this.ruleForm.nonghuEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.jinyongTypes)&& 'nonghu'==this.flag){
