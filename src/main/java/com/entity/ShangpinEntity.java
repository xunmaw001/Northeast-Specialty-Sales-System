...
public class ShangpinEntity<T> implements Serializable {
    ...
    @TableField(value = "nonghu_id")

    private Integer nonghuId;
    ...
    public void setNonghuId(Integer nonghuId) {
