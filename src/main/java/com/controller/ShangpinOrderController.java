    ...
    */
    ...
    public R add(@RequestBody ShangpinOrderEntity shangpinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,shangpinOrder:{}",this.getClass().getName(),shangpinOrder.toString());
            ...
            NonghuEntity nonghuEntity = nonghuService.selectById(shangpinEntity.getNonghuId());
            nonghuEntity.setNewMoney(nonghuEntity.getNewMoney()+shangpinOrder.getShangpinOrderTruePrice());//动态计算金额
            nonghuService.updateById(nonghuEntity);
